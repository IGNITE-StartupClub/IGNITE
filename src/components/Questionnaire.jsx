        ...
        <>
          ...
          <button
            ...
            disabled={
              ...
              Object.keys(config.step3?.questions || {}).some(
                (qId) => config.step3.questions[qId].required && !data[qId]?.trim(),
              )
            }
          >
            Weiter
      ...
      {step === 4 && Object.keys(config.step4?.questions || {}).length > 0 && (
        <>
          ...
          <button
            ...
            className="button secondary"
            onClick={next}
            disabled={Object.keys(config.step4.questions).some(
              (qId) => config.step4.questions[qId].required && !data[qId]?.trim(),
            )}
          >
            Weiter
          </button>
      ...
      {step === 5 && Object.keys(config.step5?.questions || {}).length > 0 && (
        <>
          ...
          <button
            ...
            className="button secondary"
            onClick={next}
            disabled={Object.keys(config.step5.questions).some(
              (qId) => config.step5.questions[qId].required && !data[qId]?.trim(),
            )}
          >
            Weiter
          </button>
